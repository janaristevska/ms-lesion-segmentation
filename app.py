...
class wm_seg:
    ...
    def __init__(self, master, container):
        ...
        self.checkPretrain = Checkbutton(self. model_frame,
                                         text="use pretrained",
                                         variable=self.param_use_pretrained_model)
    ...
    def parameter_window(self):
        ...
        balanced_entry = Checkbutton(tr_model,
                                     ...
                                     variable=self.param_balanced_dataset)
    ...
    def load_default_configuration(self):
        ...
        self.param_register_modalities.set(default_config.getboolean('database', 'register_modalities'))
        self.param_denoise.set(default_config.getboolean('database', 'denoise'))
        self.param_denoise_iter.set(default_config.getint('database', 'denoise_iter'))
        self.param_skull_stripping.set(default_config.getboolean('database', 'skull_stripping'))
        self.param_save_tmp.set(default_config.getboolean('database', 'save_tmp'))
        self.param_debug.set(default_config.getboolean('database', 'debug'))

        # train parameters
        self.param_use_pretrained_model.set(default_config.getboolean('train', 'full_train'))
        self.param_pretrained_model.set(default_config.get('train', 'pretrained_model'))
        self.param_inference_model.set("      ")
        self.param_balanced_dataset.set(default_config.getboolean('train', 'balanced_training'))
        ...
        self.param_net_verbose.set(default_config.getint('model', 'net_verbose'))
    ...
    def about_window(self):
        ...
        if self.container is False:
             ...
             version_number = Label(t, text="commit: " + str(self.commit_version))
    ...
    def process_container_queue(self):
        ...
        try:
            msg = self.test_queue.get(block=False)
